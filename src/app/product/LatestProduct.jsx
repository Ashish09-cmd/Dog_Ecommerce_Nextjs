   ...
   <>
    <section className='pb-10 bg-white px-3'>
        <div className="container">
         <h6 className='text-center font-medium text-lg italic text-orange '>Trending Products</h6>
         <h3 className='text-4xl font-bold text-center'>Latest Product</h3>
...
<div>
 ...
 <img className='latest-card-img rounded-lg' src={a.thumbnail} alt="" />
 </div>
 ...
 <h5 className='font-bold text-xl text-red-600'><span className='line-through text-black font-medium'>{a.oldPrice}</span> {a.price}</h5>
</div>
            </div>
